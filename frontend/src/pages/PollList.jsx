  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100 p-6">
      <div className="max-w-xl mx-auto">
        ...
        <h1 className="text-2xl font-bold mb-6 text-violet-500">Recent polls</h1>
        {polls.length === 0 ? (
          <p className="text-zinc-400">No polls yet. <Link to="/create" className="text-violet-500 hover:underline">Create one</Link>.</p>
        ) : (
          <ul className="space-y-3">
            {polls.map((poll) => (
              <li key={poll.id}>
                ...
                >
                  <span className="text-zinc-100 font-medium">{poll.question}</span>
