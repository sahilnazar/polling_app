  ...
  return (
    <div className="min-h-screen bg-background text-text-primary p-6">
      <div className="max-w-xl mx-auto">
        ...
        <h1 className="text-2xl font-bold mb-6 text-text-primary">{poll.question}</h1>
        ...
        {!hasVoted ? (
          <div className="space-y-4">
            ...
            <button
              ...
              className="w-full py-3 rounded-xl bg-accent text-white font-medium hover:opacity-90 disabled:opacity-50 transition mt-4"
            >
                ...
                return (
                  <div key={opt.id} className="rounded-xl border border-zinc-800 overflow-hidden">
                    ...
                    <div className="h-2 bg-zinc-800">
                      <div
                        className="h-full bg-accent rounded-r transition-all duration-500 ease-out"
                        style={{ width: `${pct}%` }}
                      />
                    </div>
                  </div>
